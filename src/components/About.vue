<template>
  ...
  <div class="relative px-8 py-2 md:flex md:gap-x-4 xl:gap-x-8 lg:px-20 xl:px-24 2xl:px-72 2xl:gap-x-16 lg:mt-6 bg-white">
    ...
    <div class="pt-8 text-purple-500 md:w-2/3 md:text-lg lg:text-lg xl:text-2xl bg-white pb-24">
      ...
      <p class="py-4 ">Recently, I have been working as a Front-End Developer, gaining valuable experience and developing my skills after completing my internship at a start-up where I built web applications.</p>
